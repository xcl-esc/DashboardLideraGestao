...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-p-a+g0x_-+lqismkck6(#)og97*25yr4a2wbbma2_yd3+*7kj%')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', 'False').lower() == 'true'

# Configure ALLOWED_HOSTS para produção no Render
ALLOWED_HOSTS = [
    'dashboardlideragestao.onrender.com',  # Seu domínio no Render
    'localhost',
    '127.0.0.1',
]
...
# Static files (CSS, JavaScript, Images) - CONFIGURAÇÃO CORRIGIDA
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Diretórios onde o Django vai procurar arquivos estáticos durante desenvolvimento
STATICFILES_DIRS = [
